...
#     "Github_Url": "https://github.com/Virtual-Labs/unit-operation-reaction-engineering-and¡Vprocess-control-nitk",
...
# n file with list of experiment server labs
# [
#   {
#     "Lab_ID": "fm-nitk",
#     "Lab_Url": "http://fm-nitk.vlabs.ac.in",
...
- After the changes made in the index.org file, get back to the
  expeirment-server-labs drectory and open make file and add below
  lines in the make file inside build section. Save the file.
#+BEGIN_SRC 
