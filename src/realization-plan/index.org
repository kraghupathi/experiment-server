...
|------+-------+---------+----------------------------+------+--------+---------+---------+--------|
|    1 |     1 |         | Automate-experiment-server |      | Closed | 240hrs  | 192hrs  | [[https://gitlab.com/vlead-systems/experiment-server/issues?scope=all&utf8=%E2%9C%93&state=closed][ref]]    |
|------+-------+---------+----------------------------+------+--------+---------+---------+--------|
|      |       |         |                            |      |        |         |         |        |
|------+-------+---------+----------------------------+------+--------+---------+---------+--------|
|      |       |         |                            |      |        |         |         |        |
...
|      | running from experiment server                                    |        | 240hrs            | 192hrs        |                |               |           |              |
|------+-------------------------------------------------------------------+--------+-------------------+---------------+----------------+---------------+-----------+--------------|
